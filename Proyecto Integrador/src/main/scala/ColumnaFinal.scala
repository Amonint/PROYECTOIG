...
object ColumnaFinal extends App {
  ...
  val reader = CSVReader.open(new File("Aqui la ruta del archivo"))
  val data = reader.allWithHeaders()
  reader.close()

  //Comando para poder conectar a la data base.
  Class.forName("com.mysql.cj.jdbc.Driver")
  ConnectionPool.singleton("jdbc:mysql://localhost:3306/movie_data", "root", "Aqui su contraseña de MySQl")
